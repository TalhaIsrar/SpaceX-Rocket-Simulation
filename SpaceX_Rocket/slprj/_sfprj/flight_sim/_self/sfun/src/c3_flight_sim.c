...
static const char * c3_debug_family_names[12] = { "CD", "Di", "A", "T", "p",
  "rho", "Drag", "nargin", "nargout", "h", "v", "D" };

/* Function Declarations */
static void initialize_c3_flight_sim(SFc3_flight_simInstanceStruct
  *chartInstance);
static void initialize_params_c3_flight_sim(SFc3_flight_simInstanceStruct
  *chartInstance);
static void enable_c3_flight_sim(SFc3_flight_simInstanceStruct *chartInstance);
static void disable_c3_flight_sim(SFc3_flight_simInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_flight_sim(SFc3_flight_simInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_flight_sim(SFc3_flight_simInstanceStruct *
  chartInstance);
static void set_sim_state_c3_flight_sim(SFc3_flight_simInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_flight_sim(SFc3_flight_simInstanceStruct *chartInstance);
static void sf_c3_flight_sim(SFc3_flight_simInstanceStruct *chartInstance);
static void c3_chartstep_c3_flight_sim(SFc3_flight_simInstanceStruct
  *chartInstance);
static void initSimStructsc3_flight_sim(SFc3_flight_simInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_flight_simInstanceStruct *chartInstance,
  const mxArray *c3_D, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_flight_simInstanceStruct *chartInstance,
...
static void c3_eml_scalar_eg(SFc3_flight_simInstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_flight_simInstanceStruct *chartInstance, real_T
  c3_a);
static void c3_eml_error(SFc3_flight_simInstanceStruct *chartInstance);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_flight_simInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_flight_simInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_flight_sim, const char_T
  *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_flight_simInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_flight_simInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_flight_sim = 0U;
}
  ...
  chartInstance)
{
  ...
  real_T *c3_D;
  c3_D = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellarray(2), FALSE);
  c3_hoistedGlobal = *c3_D;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_flight_sim;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_D = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)),
    "D");
  chartInstance->c3_is_active_c3_flight_sim = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_flight_sim");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_flight_sim(chartInstance);
...
static void sf_c3_flight_sim(SFc3_flight_simInstanceStruct *chartInstance)
{
  ...
  c3_D = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_h = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_h, 0U);
  _SFD_DATA_RANGE_CHECK(*c3_D, 1U);
  _SFD_DATA_RANGE_CHECK(*c3_v, 2U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_flight_sim(chartInstance);
  ...
  *chartInstance)
{
  ...
  c3_b_D = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_h = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_h;
  c3_b_hoistedGlobal = *c3_b_v;
  c3_h = c3_hoistedGlobal;
  c3_v = c3_b_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 12U, 12U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_CD, 0U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_Di, 1U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_A, 2U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_T, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_p, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_rho, 5U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Drag, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_h, 9U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_v, 10U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_D, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_A = 1.7671458676442586;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 7);
  if (CV_EML_IF(0, 1, 0, c3_h <= 11000.0)) {
    ...
    c3_x = c3_b_A;
    c3_b_x = c3_x;
    c3_b_y = c3_b_x / 288.08;
    c3_b_b = c3_mpower(chartInstance, c3_b_y);
    c3_p = 101.29 * c3_b_b;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 11);
    guard1 = FALSE;
    if (CV_EML_COND(0, 1, 0, 11000.0 < c3_h)) {
      if (CV_EML_COND(0, 1, 1, c3_h <= 25000.0)) {
        ...
        c3_c_b = c3_h;
        c3_c_y = 0.000157 * c3_c_b;
        c3_c_x = 1.73 - c3_c_y;
        c3_d_x = c3_c_x;
        c3_d_x = muDoubleScalarExp(c3_d_x);
        c3_d_b = c3_d_x;
        c3_p = 22.65 * c3_d_b;
      } else {
        guard1 = TRUE;
    ...
    if (guard1 == TRUE) {
      ...
      c3_eml_scalar_eg(chartInstance);
      c3_ar = c3_d_a;
      c3_c = muDoubleScalarPower(c3_ar, -11.388);
      c3_f_b = c3_c;
      c3_p = 2.488 * c3_f_b;
    }
  }
  ...
  c3_i_a = c3_h_a;
  c3_i_b = c3_h_a;
  c3_b_c = c3_i_a * c3_i_b;
  c3_j_a = c3_i_y;
  c3_j_b = c3_b_c;
  c3_j_y = c3_j_a * c3_j_b;
  c3_k_a = c3_j_y;
  c3_k_y = c3_k_a * 1.7671458676442586;
  c3_l_a = c3_k_y;
  c3_Drag = c3_l_a * 0.075;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u;
  const mxArray *c3_y = NULL;
  SFc3_flight_simInstanceStruct *chartInstance;
  chartInstance = (SFc3_flight_simInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_flight_sim_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363699478U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363700156U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1331290458U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363699480U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                  "resolved", 5);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286807996U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m"),
                  "resolved", "resolved", 6);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1358171740U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363699454U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286807926U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 14);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1373295708U), "fileTimeLo",
                  "fileTimeLo", 14);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 14);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1319719166U), "mFileTimeLo",
                  "mFileTimeLo", 14);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 14);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 18);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363699466U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1343819558U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("exp"), "name", "name", 20);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/exp.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1343819580U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1301317664U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  c3_a)
{
  ...
  c3_eml_scalar_eg(chartInstance);
  c3_ar = c3_d_a;
  return muDoubleScalarPower(c3_ar, 5.258);
}
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_flight_sim), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_flight_sim);
  return c3_y;
}
...
void sf_c3_flight_sim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_flight_sim_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_flight_sim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_flight_sim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_flight_sim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"D\",},{M[8],M[0],T\"is_active_c3_flight_sim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_flight_sim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_flight_simInstanceStruct *chartInstance;
    chartInstance = (SFc3_flight_simInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c3_D = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c3_h = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c3_h);
          _SFD_SET_DATA_VALUE_PTR(1U, c3_D);
...
static void sf_opaque_initialize_c3_flight_sim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_flight_simInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_flight_sim((SFc3_flight_simInstanceStruct*)
    chartInstanceVar);
  initialize_c3_flight_sim((SFc3_flight_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_flight_sim(void *chartInstanceVar)
{
  enable_c3_flight_sim((SFc3_flight_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_flight_sim(void *chartInstanceVar)
{
  disable_c3_flight_sim((SFc3_flight_simInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_flight_sim(void *chartInstanceVar)
{
  sf_c3_flight_sim((SFc3_flight_simInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_flight_sim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_flight_sim
    ((SFc3_flight_simInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_flight_sim();/* state var info */
...
extern void sf_internal_set_sim_state_c3_flight_sim(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_flight_sim((SFc3_flight_simInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_flight_sim(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_flight_sim(S);
}

static void sf_opaque_set_sim_state_c3_flight_sim(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_flight_sim(S, st);
}

static void sf_opaque_terminate_c3_flight_sim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_flight_simInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_flight_sim_optimization_info();
    }

    finalize_c3_flight_sim((SFc3_flight_simInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_flight_sim((SFc3_flight_simInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_flight_sim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_flight_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_flight_sim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_flight_sim(SimStruct *S)
{
  SFc3_flight_simInstanceStruct *chartInstance;
  chartInstance = (SFc3_flight_simInstanceStruct *)utMalloc(sizeof
    (SFc3_flight_simInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_flight_simInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_flight_sim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_flight_sim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_flight_sim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_flight_sim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_flight_sim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_flight_sim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_flight_sim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_flight_sim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_flight_sim;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_flight_sim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_flight_sim;
...
void c3_flight_sim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_flight_sim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_flight_sim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_flight_sim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_flight_sim_method_dispatcher.\n"
